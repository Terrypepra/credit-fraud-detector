...
def main():
    ...
    # Test legitimate transactions (should be flagged as legitimate)
    print("\n=== LEGITIMATE TRANSACTIONS (Should be LEGITIMATE) ===")
    ...
    # Test suspicious transactions (should be flagged as fraud)
    print("\n=== SUSPICIOUS TRANSACTIONS (Should be FRAUD) ===")
    ...
    test_transaction(8000, "Fake Store", "Foreign", "1234-5678-9012-3456", "High amount + fake merchant")
    ...
    test_transaction(3000, "Unknown Store", "Local", "1234-5678-9012-3456", "Medium amount + unknown merchant")
